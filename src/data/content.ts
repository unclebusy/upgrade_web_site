    ...
    items: [
      {
        ...
        value: 'A unified core for product configuration, ledger logic, and daily banking operations.',
        description: 'Designed for banks modernizing core operations without compromising control or continuity.',
        forWhom: 'Retail and commercial banks replacing fragmented operational architecture.',
      ...
      },
      {
        ...
        value: 'Connected digital channels for everyday banking across mobile and web.',
        description: 'Built for banks launching or upgrading customer-facing journeys with tighter service continuity.',
        forWhom: 'Institutions improving digital access and accelerating channel delivery.',
      ...
      },
      {
        ...
        value: 'Remote onboarding flows that shorten the path from application to activation.',
        description: 'Created for banks reducing branch dependency and increasing acquisition efficiency.',
      ...
      },
      {
        ...
        value: 'Card infrastructure, payment data, and enterprise integrations in one layer.',
        description: 'Shaped for banks improving interoperability across payment rails, card systems, and ERP.',
        forWhom: 'Institutions strengthening payment operations and integration reliability.',
      ...
      },
      {
        ...
        value: 'A centralized layer for transactional alerts and service communications.',
        description: 'Built for banks that need consistent messaging and cleaner orchestration across channels.',
        forWhom: 'Institutions scaling alerts, customer messaging, and operational communications.',
...
const ru: HomePageContent = {
  ...
  solutions: {
    ...
    items: [
      {
        id: 'core-banking',
        category: 'Ядро платформы',
        title: 'Core Banking System',
        value: 'Единое ядро для настройки продуктов, учётной логики и ежедневных банковских операций.',
        description: 'Для банков, которые обновляют core-операции без потери контроля и операционной устойчивости.',
        forWhom: 'Розничные и коммерческие банки, уходящие от фрагментированной архитектуры операций.',
        capabilities: ['Операции по продуктам и счетам', 'Управление workflow', 'Операционная отчётность'],
        useCases: ['Модернизация core', 'Консолидация процессов', 'Стандартизация платформы'],
        integrations: ['Цифровые каналы', 'Платежи', 'Слой уведомлений'],
        outcomes: ['Меньше фрагментации', 'Более чистая операционная модель', 'Сильнее база для внедрения'],
        action: { label: 'Запросить обзор', href: '/contact', variant: 'ghost' },
      },
      {
        id: 'digital-banking',
        category: 'Цифровые каналы',
        title: 'Mobile & Internet Banking',
        value: 'Связанные цифровые каналы для повседневного банкинга в mobile и web.',
        description: 'Для банков, которые запускают или обновляют клиентские сценарии с более целостным сервисным опытом.',
        forWhom: 'Организации, улучшающие цифровой доступ и ускоряющие запуск каналов обслуживания.',
        capabilities: ['Мобильный банкинг', 'Интернет-банкинг', 'Сценарии веб-портала'],
        useCases: ['Запуск канала', 'Цифровой редизайн', 'Рост самообслуживания'],
        integrations: ['Core banking', 'Уведомления', 'Удалённый онбординг'],
      ...
      },
      {
        ...
        category: 'Онбординг',
        title: 'Remote Customer Acquisition',
        value: 'Удалённый онбординг, сокращающий путь от заявки до активации клиента.',
        description: 'Для банков, которые снижают зависимость от отделений и повышают эффективность привлечения.',
        forWhom: 'Банки и финансовые организации, расширяющие цифровое открытие счетов.',
        capabilities: ['Удалённый онбординг', 'Workflow обработки заявок', 'Логика активации клиента'],
        useCases: ['Цифровое открытие счёта', 'Расширение привлечения', 'Более быстрые KYC-сценарии'],
        integrations: ['Core banking', 'Цифровые каналы', 'Сервисы уведомлений'],
        outcomes: ['Более быстрый онбординг', 'Шире охват привлечения', 'Меньше трения на первом шаге'],
        action: { label: 'Запросить обзор', href: '/contact', variant: 'ghost' },
      },
      {
        id: 'payments',
        category: 'Платежи',
        title: 'Card & Payment Solutions',
        value: 'Карточная инфраструктура, платёжные данные и enterprise-интеграции в одном слое.',
        description: 'Для банков, которым нужна более чистая связность между платёжными рельсами, card systems и ERP.',
        forWhom: 'Организации, усиливающие платёжные операции и надёжность интеграций.',
        capabilities: ['Хранение карточных данных', 'API карточных систем', 'Интеграция с ERP'],
        useCases: ['Интеграция платёжных систем', 'Корпоративная сверка', 'Расширение сервисов'],
        integrations: ['Карточные системы', 'ERP-платформы', 'Core и отчётные слои'],
        outcomes: ['Чище совместимость', 'Более связные платёжные операции', 'Операционное упрощение'],
        action: { label: 'Запросить обзор', href: '/contact', variant: 'ghost' },
      },
      {
        id: 'notifications',
        ...
        title: 'Notification Service',
        value: 'Централизованный слой для транзакционных уведомлений и сервисных коммуникаций.',
        description: 'Для банков, которым нужна единая логика сообщений и более чистая оркестрация по каналам.',
        forWhom: 'Организации, масштабирующие alerts, клиентские сообщения и операционные коммуникации.',
        capabilities: ['Центральная оркестрация сообщений', 'Транзакционные уведомления', 'Переиспользуемые коммуникационные сценарии'],
        useCases: ['Сервисные уведомления', 'Транзакционные уведомления', 'Кросс-канальные сообщения'],
        integrations: ['Цифровые каналы', 'Core banking', 'Операционные события'],
        outcomes: ['Последовательные сообщения', 'Быстрее оркестрация сервисов', 'Выше доверие клиентов'],
        action: { label: 'Запросить обзор', href: '/contact', variant: 'ghost' },
      },
    ],
  },
